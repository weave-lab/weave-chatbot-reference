...
def generate_chat_response(client: genai.Client, system_prompt: str, user_message: str, chat_history: list=[], context_snippets: list=[], model: str = "gemini-2.5-flash", verbose: bool = False) -> str:
    parameters = {
...
def main():
    ...
    parser.add_argument("--verbose", "-v", action="store_true", help="Enable verbose output for RAG retrieval details.")
    ...
    print("CLI Chat Client. Type 'quit' or 'exit' to end the chat.\n" 
    ...
    while True: # REPL for CLI chat
        ...
        retrieved_context = vector_store.retrieve(query_embedding, 
                                                  top_k=VECTOR_TOP_K, 
        ...
        response = generate_chat_response(genai_client,
                                          system_prompt,
                                          user_message,
                                          chat_history,
                                          retrieved_context,
